                    ...
                    <div class="modal-content">
                        <div class="boxed boxed--lg">
                            ...
                            <div class="text-center">
                                <a class="btn btn--lg btn--primary type--uppercase" href="{{ route('account', ['messages']) }}">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <h2>What we do?</h2>
                    <p class="lead">
                        It’s pretty simple! We connect the lenders with the renters to encourage the business of renting products and commodities in the same neighbourhood.
                    </p>
                </div>
            </div>
            <!--end of row-->
