    ...
    return a.accordions = a.accordions || {}, a.accordions.documentReady = function (b) {
        b(".accordion__title").on("click", function () {
            ...
            var a = b(this),
                c = a.outerHeight(!0);
            a.css("min-height", c)
        }), "" !== c.location.hash && "#" !== c.location.hash && b(".accordion li" + b(this).attr("href")).length && a.accordions.activatePanelById(c.location.hash, !0), jQuery(d).on("click", 'a[href^="#"]:not(a[href="#"])', function () {
